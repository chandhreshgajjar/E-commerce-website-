                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                            ...
                            <div class="header-logo">
                                <div class="logo">
                                    <a href="orders.php"><img src="assets/images/logo/logo.png" style="padding:0 30px 0 0" alt=""></a>
                                </div>
                            </div>
                            <!-- End Header Logo -->
                                ...
                                <nav>
                                    <ul>
                                        <li class="has-dropdown">
                                            <a class="active main-menu-link" href="#"<i
                                                    class=""></i>Update Quantity</a>      
                                        </li>
										<li class="has-dropdown">
                                            <a class="active main-menu-link" href="#"<i
                                                    class=""></i>Stock Availability</a>      
                                        </li>
										<li class="has-dropdown">
                                            <a class="active main-menu-link" href="#"<i
                                                    class=""></i>Product Review</a>      
                                        </li>
