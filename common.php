...
<?php
	...
	if(isset($_GET['category_id'])){
		...
		$dis=$link->rawQueryOne("SELECT * FROM bg_image JOIN category ON bg_image.category_id = category.category_id where category.category_id=?",array($category_id));
		if($link->count == 0){
			echo "Data not found";
		}
	}
...
<!-- Mirrored from htmldemo.net/hono/hono/shop-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:24:24 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title><?php echo $dis['category_name']?></title>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-single-slider-item swiper-slide">
                    ...
                    <div class="hero-slider-bg">
                        <img src="<?php echo $dis['bg_img']?>" alt="">
                    </div>
                    <!-- Hero Slider Content -->
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <h1 class="title"></h1>
										<p style="font-size:40px;color:#000000;font-family:Open Sans,sans-serif;font-weight:600"><?php echo $dis['category_name']?><p> 	
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sort-product-tab-wrapper">
                        <div class="container">
                            <div class="row">
								...
								<h1 style="margin-top:50px;text-transform:uppercase;text-align:center;font-weight:600">our collection</h1>
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active show sort-layout-single" id="layout-4-grid">
											...
											<?php
												...
												$proShow=$link->rawQuery("select * from product_category join product on product_category.product_id = product.product_id join product_price on product.product_id = product_price.product_id where product_category.category_id=?",array($category_id));
												foreach($proShow as $p){
													if($link->count > 0){
											...
											?>
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        data-aos="fade-up" data-aos-delay="0">
                                                        <div class="image-box">
                                                            <a href="product-details.php?product_id=<?php echo $p['product_id'];?>&category_id=<?php echo $p['category_id'];?>" class="image-link">
                                                        ...
                                                        <div class="content">
                                                            <div class="content-left">
                                                                <h6 class="title"><a
                                                                        href="product-details-default.html"><?php echo $p['product_name']?></a></h6>
                                                            ...
                                                            <div class="content-right">
                                                                <span class="price">Rs.<?php echo $p['product_price']?></span>
                                                            </div>
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/8.jpg"
                                                                    alt="">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/3.jpg"
                                                                    alt="">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/4.jpg"
                                                                    alt="">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/5.jpg"
                                                                    alt="">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/6.png"
                                                                    alt="">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        ...
                                                        <div class="image-box">
                                                            <a href="product-details-default.html" class="image-link">
                                                                <img src="assets/images/product-2/ring/10.jpg"
                                                                    alt="">
...
<!-- Mirrored from htmldemo.net/hono/hono/shop-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:24:25 GMT -->
</html>