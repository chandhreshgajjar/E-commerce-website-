                    ...
                    <div class="row mb-n6">
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--green" data-aos="fade-up"
                                data-aos-delay="600">
                                <h5 class="title">CONATACT US</h5>
                                <div class="footer-about">
                                    <ul>
									<address style="color:#505050">
									<li>Store Address :</li>
									<li>Ground floor shop no.9 Shiv</li>
									<li>arshan appartment punagam</li>
									</address>
									<li style="color:#505050">Tel No : +91-9173535154</li>
									<li style="color:#505050">Email : nudraindia@gmail.com</li>
									</ul>
                                </div>
                            </div>
