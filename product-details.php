...
<?php
	...
	if(isset($_GET['product_id'])){
		...
		$proDet = $link->rawQueryOne("SELECT * FROM product_price JOIN product ON product_price.product_id = product.product_id where product.product_id=?",array($product_id));
		if($link->count == 0){
			echo ("Date not found");
		}
	}
...
<!-- Mirrored from htmldemo.net/hono/hono/product-details-default.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:24:21 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Product Detail| Nudra</title>
                        ...
                        <div class="product-large-image product-large-image-horaizontal swiper-container">
                            <div class="swiper-wrapper">
                                <div class="product-image-large-image swiper-slide zoom-image-hover img-responsive">
                                    <img src="<?php echo $proDet['product_image'];?>" alt="" name="prodImg">
                                </div>
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="product-details-content-area product-details--golden" data-aos="fade-up"
                        ...
                        <div class="product-details-text">
                            <h4 class="title" name="prodName"><?php echo $proDet['product_name'];?></h4>
                            ...
                            <div class="price" name="prodPrice">Rs. <?php echo $proDet['product_price'];?></div>
                        ...
                        <div class="product-details-variable">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="product-add-to-cart-btn">
                                    <button class="btn btn-block btn-lg btn-black-default-hover"
                                        data-bs-toggle="modal" data-bs-target="#" name="addCart">+ Add To Cart</button>
                                </div>
								
                            </div>
                            <!-- Start  Product Details Meta Area-->
                            <div class="product-details-meta mb-20">
                                <a href="add-to-wishlist.php?product_id=<?php echo $proDet['product_id'];?>&category_id=<?php echo $category_id;?>" class="icon-space-right"><i class="icon-heart"></i>Add to
                                    wishlist</a>
                        ...
                        <div class="product-slider-default-1row default-slider-nav-arrow">
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
									...
									<?php
										$category_id = $_GET['category_id'];
										$relProd = $link->rawQuery("select * from product_category join category on product_category.category_id = category.category_id join product on product_category.product_id = product.product_id join product_price on product_category.product_id = product_price.product_id where category.category_id=?",array($category_id));
										foreach($relProd as $rP){
											if($link->count > 0){
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details.php?product_id=<?php echo $rP['product_id'];?>&category_id=<?php echo $rP['category_id'];?>" class="image-link">
                                                <img src="<?php echo $rP['product_image'];?>" alt="">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details.php"><?php echo $rP['product_name'];?></a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="content-right">
                                                <span class="price">Rs.<?php echo $rP['product_price'];?></span>
                                            </div>
                                        </div>
                                    </div>
									<?php
...
<!-- Mirrored from htmldemo.net/hono/hono/product-details-default.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:24:22 GMT -->
</html>
