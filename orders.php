...
<head>
    ...
    <title>Consumer Order|Nudra</title>
                                ...
                                <table>
                                    ...
                                    <thead>
                                        <tr>
											...
											<th class="product_name">Consumer Name</th>
                                            <th class="product-price">Payment Type</th>
                                            <th class="product_name">Address</th>
											<th class="product_name">City</th>
											<th class="product_name">State</th>
											<th class="product_name">Pincode</th>
											<th class="product_total">Total</th>
											<th class="product_name">Order Cancel Status</th>
                                    ...
                                    <tbody>
										...
										<?php
											$show = $link->rawQuery("select * from order_product join order_item on order_product.order_product_id = order_item.order_product_id join product on order_item.product_id = product.product_id");
											if($link->count > 0){
												foreach($show as $s){
                                        ...
                                        <tr>
											...
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['Fname'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['payment_type'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['order_address'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['order_city'];?></a></td>
                                            <td class="product_name" name="product_name"><a href="#"><?php echo $s['order_state'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['order_pincode'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php echo $s['order_total'];?></a></td>
											<td class="product_name" name="product_name"><a href="#"><?php 
											
												$cancel = $s['order_cancel'];
