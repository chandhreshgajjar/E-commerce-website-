...
<!-- Mirrored from htmldemo.net/hono/hono/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:23:48 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Nudra|Wishlist</title>
	...
	<div class="col-12">
                    <div class="user-actions accordion" data-aos="fade-up" data-aos-delay="0">
                        <h3>
                            ...
                            Please Login in to see your wishlist products.
                            ...
                            <div class="table_page table-responsive">
                                <table>
                                    ...
                                    <tbody>
										...
										<form name="wishList" method="POST" action="wish-to-cart.php">
                                        <?php
											$user_id = $_SESSION['user_id'];
											$list = $link->rawQuery("select * from wishlist join product on product.product_id = wishlist.product_id join product_price on product_price.product_id = wishlist.product_id join user on user.user_id = wishlist.user_id where user.user_id=?",array($user_id));
										...
										?>
										<tr>
                                            <td class="product_remove"><a href="delete-product-wishlist.php?wishlist_id=<?php echo $l['wishlist_id'];?>"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                            <td class="product_thumb"><a href="product-details-default.html"><img
                                                        src="<?php echo $l['product_image'];?>"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="product-details-default.html"><?php echo $l['product_name']?></a></td>
                                            <td class="product-price">Rs. <?php echo $l['product_price'];?></td>
                                            ...
                                            <td class="product_addcart"><a href="wish-to-cart.php?product_id=<?php echo $l['product_id'];?>&category_id=<?php echo $l['category_id'];?>"class="btn btn-md btn-golden">Add To Cart</a></td>
                                        </tr> 
										<?php
